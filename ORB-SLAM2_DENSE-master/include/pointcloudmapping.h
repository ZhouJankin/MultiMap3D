...
public:
    ...
    /**
     * @brief Thread-safe interface to get Keyframe point cloud map
     *
     * @return
     */
    bool getKeyframeCloud(PointCloud::Ptr &pCloud);
...
protected:
    ...
    //update
    PointCloud::Ptr mpPclKeyframeCloud;
    ...
    //update 加一个Keyframeupdate的锁
    mutex mMtxKeyframeCloudUpdated;
